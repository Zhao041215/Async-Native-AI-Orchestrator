...
- wp-ss-01: Implement identity-and-access | owner=backend | phase=implementation | partition=backend | subsystems=ss-01
- wp-ss-02: Implement product-web-app | owner=frontend | phase=implementation | partition=frontend | subsystems=ss-02
- wp-ss-03: Implement application-api | owner=backend | phase=implementation | partition=backend | subsystems=ss-03
- wp-ss-04: Implement domain-services | owner=backend | phase=implementation | partition=backend | subsystems=ss-04
- wp-ss-05: Implement data-and-reporting | owner=devops | phase=approval_required | partition=integration | subsystems=ss-05
