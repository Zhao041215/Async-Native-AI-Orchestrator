    ...
    *,
    ...
    memory = {
        ...
        "layers": {
            ...
            "package_memory": {
                str(package.get("package_key", "")): {
                    "role": package.get("role", ""),
                    "subsystem": package.get("subsystem", ""),
                    "wave_key": package.get("wave_key", ""),
                    ...
                    "acceptance_gates": package.get("acceptance_gates", []),
                }
                for package in packages
            },
        ...
        "retrieval_policy": {
            ...
            "code_index_hash": (code_index or {}).get("index_hash", ""),
            "contract_index_hash": (contract_index or {}).get("index_hash", ""),
        },
    }
...
def memory_for_package(memory: dict[str, Any], package: dict[str, Any]) -> dict[str, Any]:
    ...
    subsystem_memory = [
        item
        for item in ((memory.get("layers") or {}).get("subsystem_memory") or [])
